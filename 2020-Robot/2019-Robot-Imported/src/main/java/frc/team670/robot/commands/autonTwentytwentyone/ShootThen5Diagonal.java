package frc.team670.robot.commands.autonTwentytwentyone;
...
/**
 * Autonomous routine starting by shooting 3 balls depending on start position (left or center)
...
public class ShootThen5Diagonal extends SequentialCommandGroup{

    // private Map<MustangSubsystemBase, HealthState> healthReqs;
    // private DriveBase driveBase;
    private Path trajectory;
    
    // public ShootThen5Diagonal(StartPosition startPosition, DriveBase driveBase) {
    public ShootThen5Diagonal(String startPosition, DriveBase driveBase) {
