 ...
 * Add your docs here.
 */
public class IntakeBallIntakeForwardToNeutral extends ArmTransition {
    public IntakeBallIntakeForwardToNeutral (Arm arm){
        super(Arm.getArmState(LegalState.INTAKE_BALL_INTAKE_FORWARD), Arm.getArmState(LegalState.NEUTRAL), arm);
