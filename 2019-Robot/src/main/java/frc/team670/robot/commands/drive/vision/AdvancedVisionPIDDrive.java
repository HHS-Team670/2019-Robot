...
public class AdvancedVisionPIDDrive extends Command {
  ...
  public AdvancedVisionPIDDrive() {
    ...
    distanceController = new PIDController(P, I, D, F, new TwoEncoder_PIDSource(Robot.driveBase.getLeftMustangEncoder(), Robot.driveBase.getRightMustangEncoder()), new NullPIDOutput());
  ...
  private class TwoEncoder_PIDSource implements PIDSource {
    private MustangEncoder leftEncoder, rightEncoder;

    private double initialLeft, initialRight;

    private PIDSourceType pidSourceType;

    public TwoEncoder_PIDSource(MustangEncoder left, MustangEncoder right) {
    ...
    public double pidGet() {
      ...
      displacementLeft = leftEncoder.getPosition() - initialLeft;
      displacementRight = rightEncoder.getPosition() - initialRight;
