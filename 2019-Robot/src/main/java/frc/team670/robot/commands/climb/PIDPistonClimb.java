...
public class PIDPistonClimb extends Command {

  private double tiltControllerLowerOutput = 1.0, tiltControllerUpperOutput = 1.5;
  private double tolerance;
  private double P = 0.0, I = 0.0, D = 0.0, F = 0.0; //TODO set these values
  private PIDController tiltController;
  private boolean goingUp;

  public PIDPistonClimb(boolean goingUp) {
  ...
  protected void initialize() {
    Robot.climber.enablePistonControllers();
