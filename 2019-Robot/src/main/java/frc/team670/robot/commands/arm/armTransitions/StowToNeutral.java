...
public class StowToNeutral extends ArmTransition {
  
  public StowToNeutral(Arm arm) {
    super(Arm.getArmState(LegalState.STOW), Arm.getArmState(LegalState.NEUTRAL), arm);
