 ...
 * Add your docs here.
 */
public class NeutralToIntakeBallIntakeForward extends ArmTransition {
    public NeutralToIntakeBallIntakeForward (Arm arm){
        super(Arm.getArmState(LegalState.NEUTRAL), Arm.getArmState(LegalState.INTAKE_BALL_INTAKE_FORWARD), arm);
