...
public class Elbow extends BaseElbow {
  ...
  private static final double ARBITARY_FEEDFORWARD_FULL_EXTENSION = 0.05; // Hopefully don't need this since linearly scaling replaces it. Arbitrary Feedforward when elbow is fully extended TODO SET THIS
