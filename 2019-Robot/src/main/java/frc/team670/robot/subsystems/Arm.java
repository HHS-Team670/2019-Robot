...
public class Arm {
  ...
  public enum LegalState {
    ...
    INTAKE_HATCH_LOADINGSTATION_FORWARD(9), INTAKE_HATCH_LOADINGSTATION_BACK(10), INTAKE_HATCH_GROUND_BACK(11), // may not exist
    PLACE_BALL_CARGOSHIP_FORWARD(12), PLACE_BALL_CARGOSHIP_BACK(13), PLACE_HATCH_CARGOSHIP_FRONT(14),
