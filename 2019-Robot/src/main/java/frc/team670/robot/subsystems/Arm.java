...
public class Arm {
  ...
  public static Point2D.Double getCoordPosition(double elbowAngle, double wristAngle, double extensionLength) {
    double x = extensionLength * Math.sin(elbowAngle) + RobotConstants.CLAW_LENGTH_IN_INCHES * Math.sin(wristAngle);
    double y = extensionLength * Math.cos(elbowAngle) + RobotConstants.CLAW_LENGTH_IN_INCHES * Math.cos(wristAngle)
