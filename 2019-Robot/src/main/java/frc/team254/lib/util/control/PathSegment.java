package frc.team254.lib.util.control;
...
import frc.team254.lib.util.motion.MotionProfile;
import frc.team254.lib.util.motion.MotionProfileConstraints;
import frc.team254.lib.util.motion.MotionProfileGenerator;
import frc.team254.lib.util.motion.MotionProfileGoal;
import frc.team254.lib.util.motion.MotionState;
...
public class PathSegment {
    ...
    public void createMotionProfiler(MotionState start_state, double end_speed) {
        MotionProfileConstraints motionConstraints = new MotionProfileConstraints(maxSpeed,
                RobotConstants.pathFollowingMaxAccel);
